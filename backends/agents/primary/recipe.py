...
r = redis.Redis(
  host='redis-17537.c309.us-east-2-1.ec2.redns.redis-cloud.com',
  port=17537,
  password='MFDpWP9I6xfUkixzo3EAPiZoMmlqQfpy')
...
async def generate_response(context, query):
    ...
    prompt_template = """
        ...
        * Cooking tips: Offer helpful advice or substitutions to enhance the dish.
        ...
        Do not try to create your own question and answer, only answer the user request.
